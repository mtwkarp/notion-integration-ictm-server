export const Types = {
  ...
  CoursesScheduleNDBModifier: Symbol.for('CoursesScheduleNotionDatabaseModifier'),
  CoursesScheduleNDBDataGetter: Symbol.for('CoursesScheduleNotionDatabaseDataGetter'),
